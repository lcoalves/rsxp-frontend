...
export default function Login() {
  ...
  return (
    <div className="bg-static-pages-image-quiz3 d-flex flex-column flex-1 p-0 flex-lg-row">
            ...
            <CardBody className="d-flex flex-column justify-content-center">
              ...
              >
                <div className="d-flex justify-content-around align-items-center">
                  <div>1</div>
                  <div>
                    <h5 className="mb-0">Resposta 1 Pergunta 3</h5>
                  </div>
                </div>
              </Button>
              <Button
              ...
              >
                <div className="d-flex justify-content-around align-items-center">
                  <div>2</div>
                  <div>
                    <h5 className="mb-0">Resposta 2 Pergunta 3</h5>
                  </div>
                </div>
              </Button>
              <Button
              ...
              >
                <div className="d-flex justify-content-around align-items-center">
                  <div>3</div>
                  <div>
                    <h5 className="mb-0">Resposta 3 Pergunta 3</h5>
                  </div>
                </div>
              </Button>
            </CardBody>
